"""
Director O.S. V20.5 — Skill & Rules Reader (Raw UGC Studio Edition)
========================================================================================================
...
def print_terminal_report(report: RulesReport, verbose: bool = False):
    ...
    print(f"{BOLD}  🎬 DIRECTOR O.S. V{report.skill_metadata.version} — SKILL & ATURAN MUTLAK READER{RESET}")
    print(f"{BOLD}{'='*90}{RESET}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Director O.S. V20.5 — Pembaca Skills & Aturan Mutlak",
