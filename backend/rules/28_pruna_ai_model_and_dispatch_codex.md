# ⚡ BREAKSTUDIO — MODULE 28: PRUNA AI MODEL & DISPATCH CODEX
========================================================================================================
...
This module serves as the **Single Source of Truth (SSOT)** for orchestrating, parameterizing, and dispatching generations to the **Pruna AI** ecosystem within BreakStudio (Raw UGC & Social Mobile Studio Edition).
...
BreakStudio natively binds to 6 specialized Pruna AI models across pre-production and final rendering:
